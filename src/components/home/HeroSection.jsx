...
const HeroSection = () => {
  return (
    <div className="container mx-auto">
      <div className="flex h-auto w-full justify-between pt-4">
        <div className="leftSection w-1/2 ">
          <div className="relative">
            <img src={Orange} alt="" className="h-full w-full pt-2" />

            <div className="absolute top-64 left-10 flex flex-col gap-5 ">
              <div>
        ...
        <div className="rightSection w-1/2 relative">
          <div className="flex justify-center pl-20">
            <img src={Blue} alt="" className=" w-[555] h-[515]" />
      ...
      <div className="flex w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto">
        ...
        />
        <Button className="rounded-r-full bg-[#EA4C89]">
